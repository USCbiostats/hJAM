...
#' \describe{
#'    \item{MI.marginal.Amatrix}{The marginal \eqn{\hat{A}}{A hat} matrix. Column one and two are the marginal estimates of the SNPs on body mass index from GIANT consortium (n = 339,224) (Locke et al., 2015) and type 2 diabetes from DIAGRAM+GERA+UKB (n = 659,316) (Xue et al., 2018), respectively}
#'    \item{MI.Amatrix}{The conditional \eqn{\hat{A}}{A hat} matrix composed by JAM and the marginal \eqn{\hat{A}}{A hat} matrix. Column one and two are the conditional effect estimates of the SNPs on body mass index and type 2 diabetes, respectively.}
...
#' \describe{
#'     \item{GTEx.PrCa.marginal.Amatrix}{The marginal \eqn{\hat{A}}{A hat} matrix with 158 genes and 182 eQTLs. The raw data was downloaded from GTEx analysis v7 (https://gtexportal.org/home/datasets). Priority Pruner was used to select the independent eQTLs. We used this matrix for MR-BMA implementation.)}
#'     \item{GTEx.PrCa.Amatrix}{The conditional A matrix with 167 genes and 447 eQTLs, which was composed by SuSiE JAM and the raw data of \eqn{\hat{A}}{A hat}  matrix.}
...
#'     \item{PrCa.lipids.Amatrix}{The conditional \eqn{\hat{A}}{A hat} matrix with 118 metabolites and 144 SNPs, which was composed by SuSiE JAM and the marginal \eqn{\hat{A}}{A hat}  matrix.}
