...
#' \describe{
#'    \item{MI.marginal.Amatrix}{The marginal Â matrix. Column one and two are the marginal estimates of the SNPs on body mass index from GIANT consortium (n = 339,224) (Locke et al., 2015) and type 2 diabetes from DIAGRAM+GERA+UKB (n = 659,316) (Xue et al., 2018), respectively}
#'    \item{MI.Amatrix}{The conditional Â matrix composed by JAM and the marginal Â matrix. Column one and two are the conditional effect estimates of the SNPs on body mass index and type 2 diabetes, respectively.}
...
#' \describe{
#'     \item{GTEx.PrCa.marginal.Amatrix}{The marginal Â matrix with 158 genes and 182 eQTLs. The raw data was downloaded from GTEx analysis v7 (https://gtexportal.org/home/datasets). Priority Pruner was used to select the independent eQTLs. We used this matrix for MR-BMA implementation.)}
#'     \item{GTEx.PrCa.Amatrix}{The conditional A matrix with 167 genes and 447 eQTLs, which was composed by SuSiE JAM and the raw data of Â matrix.}
...
#'     \item{GTEx.PrCa.rsid}{The RSID of the eQTLs}
#' }
#' @references Consortium GP. A global reference for human genetic variation. Nature 2015; 526: 68.
...
#' \describe{
#'     \item{PrCa.lipids.marginal.Amatrix}{The marginal Â matrix with 118 metabolites and 144 SNPs. This data is directly adapted from https://github.com/verena-zuber/demo_AMD (Zuber et al., 2020)}
#'     \item{PrCa.lipids.Amatrix}{The conditional Â matrix with 118 metabolites and 144 SNPs, which was composed by SuSiE JAM and the marginal Â matrix.}
